...
struct Style {
    ...
    static let mainColor : UIColor = UIColor(red:0.91, green:0.25, blue:0.26, alpha:1.00)
    static let lightWhite : UIColor = UIColor(red: 0.96, green: 0.96, blue: 0.96, alpha: 1.00)
